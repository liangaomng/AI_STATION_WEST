    ...
    def train_inference_neural(self,
        ...
        for epoch in range(self.I_num_epoch):
            ...
            for i, (batch_data, label) in enumerate(self.train_loader):
                ...
                #sparse weight -l1
                l1_norm = sum(p.abs().sum() for p in self.S_I.layers["output"].parameters())
            ...
            if epoch % 100 == 0:
                folder_path = os.path.dirname(self.S_I_Writer["model_checkpoint_path"])
                ...
                if not os.path.exists(folder_path):
                    ...
                    print(f"{folder_path} have create")
